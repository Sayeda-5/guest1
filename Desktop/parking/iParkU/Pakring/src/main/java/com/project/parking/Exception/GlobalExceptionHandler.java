...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ExceptionDTO> tutorialExceptionHandler(AdminException e, WebRequest wr){
	...
	public ResponseEntity<ExceptionDTO> tutorialExceptionHandler(SpaceNotFoundException e, WebRequest wr){
